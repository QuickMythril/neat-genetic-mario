...
-- Configuration settings for NEAT implementation in Super Mario

-- Rename _M to a more descriptive name
...
ConfigSettings.NeatConfig = {
    ...
    NodeMutationChance = 0.5,  -- Adjusted for potential algorithm improvement
}
